...
if sorted_tags:
    tag_css = "".join([
        f'.st-key-search_tag_{i} button{{background-color:{TAG_SEARCH_COLORS[i % len(TAG_SEARCH_COLORS)]};border:{"2px solid #555555" if selected_tag == tag else "1px solid " + TAG_SEARCH_COLORS[i % len(TAG_SEARCH_COLORS)]};border-radius:999px;color:#5A4650;font-weight:600;padding:.35rem .8rem;margin:0;}}'
